...
g_k8s_dex_host=[https://DEX_SERVICE_HOSTNAME]
g_k8s_dex_worker_host=[https://DEX_WORKER_SERVICE_HOSTNAME]
g_k8s_dex_port=443
g_k8s_dex_worker_port=5555
g_k8s_dex_connector_id='ldap'
...
[ x"$SAB_K8S_DEX_HOST" != x ] && g_k8s_dex_host="$SAB_K8S_DEX_HOST"
[ x"$SAB_K8S_DEX_WORKER_HOST" != x ] && g_k8s_dex_worker_host="$SAB_K8S_DEX_WORKER_HOST"
[ x"$SAB_K8S_DEX_PORT" != x ] && g_k8s_dex_port="$SAB_K8S_DEX_PORT"
[ x"$SAB_K8S_DEX_WORKER_PORT" != x ] && g_k8s_dex_worker_port="$SAB_K8S_DEX_WORKER_PORT"
[ x"$SAB_K8S_KUBECTL" != x ] && g_k8s_kubectl="$SAB_K8S_KUBECTL"
[ x"$SAB_K8S_CLU_NAME" != x ] && g_k8s_clu_name="$SAB_K8S_CLU_NAME"

# derived values
g_k8s_oauth2_uri="${g_k8s_dex_worker_host}:${g_k8s_dex_worker_port}/"
g_k8s_login_uri="${g_k8s_oauth2_uri}login"
g_k8s_dex_uri="${g_k8s_dex_host}:${g_k8s_dex_port}"
