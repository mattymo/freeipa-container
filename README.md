...
loaded in FreeIPA, you should be able to log into this container with both your
password and SSH pubkey.

This container has been modified to work in Kubernetes.

# Below is the original readme for freeipa-container
...
container to IPA server container:
    ...
    docker run -h web.example.com --link freeipa-server-container:ipa -e PASSWORD=Secret123 -ti jumpbox
